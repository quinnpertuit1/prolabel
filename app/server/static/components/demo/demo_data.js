export const demoNamedEntity = {
  ...
  docs: [
    {id: 1, 
     text: "My name is Coder McCody, a Senior Software Engineer at the Denver, CO location for Lockheed Martin. My educational background includes a computer science and statistics, followed by applied mathematics. My work experience includes a 6-year career with IBM in Salem, OR. My position there afforded me with excellent knowledge of algorithms and data mining procedures as well as ad-hoc analyses and data collection techniques that will allow me to perform exceptionally in this position.", 
     annotations: [{id: 102, label: 1, start_offset: 11, end_offset: 23, user: 1}, {id: 121, label: 9, start_offset: 34, end_offset: 51, user: 1}, {id: 181, label: 2, start_offset: 59, end_offset: 69, user: 1}, {id: 171, label: 3, start_offset: 83, end_offset: 98, user: 1}, {id: 711, label: 8, start_offset: 137, end_offset: 153, user: 1}, {id: 1551, label: 8, start_offset: 158, end_offset: 168, user: 1}, {id: 411, label: 8, start_offset: 182, end_offset: 201, user: 1}, {id: 911, label: 3, start_offset: 252, end_offset: 255, user: 1}, {id: 1001, label: 2, start_offset: 259, end_offset: 268, user: 1}, {id: 112, label: 8, start_offset: 328, end_offset: 338, user: 1}, {id: 119, label: 8, start_offset: 343, end_offset: 354, user: 1}, {id: 331, label: 8, start_offset: 377, end_offset: 392, user: 1}, {id: 113, label: 8, start_offset: 397, end_offset: 412, user: 1}]},
